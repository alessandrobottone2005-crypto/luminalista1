...
| Cambiare l’animazione     | `.blend` + `HeroAnimation.tsx`           | Poster, pausa e reduced motion        |
| Cambiare il form          | `src/features/ideas` + `IdeaSection.tsx` | UUID di conferma e test               |

...
2. Treat [`public/Logo.svg`](public/Logo.svg) and [`lumina-lista-1-project-brief.md`](lumina-lista-1-project-brief.md) as visual sources of truth.
...
- Keep Three.js code isolated in `src/components/three`. Never allocate objects or set React state inside `useFrame`; dispose manual geometries.

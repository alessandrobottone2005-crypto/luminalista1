...
export const candidates = [
  {
    ...
    surname: "Rossi",
    className: "5A",
    quote: "Una scuola in cui nessuno si senta fuori posto.",
  ...
  },
  {
    ...
    surname: "Esposito",
    className: "4B",
    quote: "Le idee migliori nascono quando ci ascoltiamo.",
  ...
  },
  {
    ...
    surname: "Romano",
    className: "5C",
    quote: "Diamo spazio a quello che ci rende diversi.",
    image: "/images/giulia.webp",
    position: "center 30%",
  },
];
